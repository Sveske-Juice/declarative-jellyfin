# Copied from: https://github.com/NixOS/nixpkgs/blob/master/pkgs/by-name/je/jellyfin-ffmpeg/package.nix
# since it's not possible to use overrideAttrs to specify version
# TODO: make PR/Issue to be able to set version and hash from overlay
{
  ffmpeg_7-full,
  fetchFromGitHub,
  fetchpatch2,
